          ...
          <tbody>
            <tr v-for="u in users" :key="u.id">
              ...
              <td class="action-cell">
                <button class="btn btn-ok btn-sm" :disabled="approving.has(u.id)" @click="approve(u)">
...
.badge-count { background: rgba(245,158,11,.15); color: #fbbf24; font-size: .75rem; font-weight: 700; padding: .1rem .5rem; border-radius: 999px; }
